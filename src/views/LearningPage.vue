    ...
    <div class="learning-category">
      <div class="learning-category__card card-wrap">
        ...
        <button
          class="btn-rs"
          @click="trainNewWords"
          :disabled="isNewWordsLoading || newWordsComplete"
        >
      ...
      <div class="learning-category__card card-wrap">
        ...
        <button class="btn-rs" :disabled="!learnedWordsCount">Let’s train!</button>
      ...
      <div class="learning-category__card card-wrap">
        ...
        <button class="btn-rs" @click="trainDifficultWords" :disabled="!difficultWordsCount">
          Let’s train!
        </button>
...
export default {
  ...
  methods: {
    ...
    ...mapMutations('Learning', ['setIsMainPage', 'setIsNewWords', 'setStartState', 'setIndex']),
